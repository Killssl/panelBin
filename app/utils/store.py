...
OFFERS_PANEL_FILE = os.path.join(os.path.dirname(__file__), "../../data/offers_panel.json")
FD_HISTORY_FILE   = os.path.join(os.path.dirname(__file__), "../../data/fd_history.json")
FD_HISTORY_MAX    = 500
